...
export TMPDIR="${GWP_MOT_TMPDIR:-/tmp/gwp_crop320x448_${date}_n${MLP_ROLE_INDEX:-${NODE_RANK:-0}}_$$}"

log_dir="$OUTPUT_ROOT/logs/robocasa_all_tshape_mot_video_pt_epoch1_randomcrop_320x448"
...
CONFIG="configs.robocasa_all_tshape_mot_video_pt_epoch1_randomcrop_320x448.config"
...
echo "=== Training RoboCasa all-data T-shape MoT video-pt epoch1 random-crop 320x448 ==="
